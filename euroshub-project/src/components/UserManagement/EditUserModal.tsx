  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#17b6b2] to-[#15a09d] px-6 py-4 flex-shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-teal-100 text-sm">Update {user.firstName} {user.lastName}&apos;s information</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="mt-4 flex items-center space-x-4">
            ...
            {hasChanges && (
              <div className="flex items-center space-x-2">
                ...
                <span className="text-teal-100 text-sm">Unsaved Changes</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          <form onSubmit={handleSubmit} className="flex flex-col h-full">
            <div className="flex-1 p-6 space-y-8">
              {errors.general && (
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-200 px-4 py-3 rounded-lg flex items-center">
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-center mb-6">
                  <div className="w-10 h-10 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center justify-center mr-3">
                    <svg className="w-5 h-5 text-[#17b6b2]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Personal Information</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Basic personal details and contact information</p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Role & Access Control</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">System permissions and account status</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    {canChangeRole ? (
                            ...
                            >
                              <div className="flex items-center space-x-3">
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center space-x-2">
                                    <span className="font-semibold text-gray-900 dark:text-white capitalize">{role}</span>
                                  ...
                                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{roleInfo.description}</p>
                                </div>
                              </div>
                            </div>
                          );
                      ...
                      <div className={`border rounded-lg p-4 bg-gray-100 dark:bg-gray-800 ${getRoleInfo(user.role).bg}`}>
                        <div className="flex items-center space-x-3">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2">
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{getRoleInfo(user.role).description}</p>
                          </div>
                        </div>
                      ...
                      <div
                        className={`relative rounded-lg p-4 cursor-pointer transition-all border ${
                          formData.isActive
                            ...
                            : 'border-gray-200 dark:border-gray-700 hover:border-green-500 bg-white dark:bg-gray-900'
                        }`}
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">User can access the system</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div
                        className={`relative rounded-lg p-4 cursor-pointer transition-all border ${
                          !formData.isActive
                            ...
                            : 'border-gray-200 dark:border-gray-700 hover:border-red-500 bg-white dark:bg-gray-900'
                        }`}
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500 dark:text-gray-400">User access is suspended</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Department and position details</p>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-2">Account Information</h4>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <span className="text-gray-700 dark:text-gray-300">Last Login:</span>
                    <span className="ml-2 text-gray-900 dark:text-white">
            ...
            <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 flex justify-between items-center flex-shrink-0">
              <button
                type="button"
                onClick={onClose}
                className="px-6 py-2 text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
                Cancel
              </button>
              ...
              <div className="flex space-x-3">
                ...
                <button
                  ...
                  className="px-8 py-2 bg-[#17b6b2] hover:bg-[#15a09d] disabled:bg-gray-400 dark:disabled:bg-gray-600 text-white rounded-lg transition-all duration-200 flex items-center transform hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
