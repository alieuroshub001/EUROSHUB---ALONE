...
import { Plus, Search, Filter, Grid, List, Star, Calendar, Users, Clock, Shield, Settings } from 'lucide-react';
...
export default function SuperAdminProjectsPage() {
  ...
  useEffect(() => {
    ...
    fetchProjects();
    fetchStats();
  }, [authLoading, isAuthenticated, user, router, page, statusFilter, priorityFilter, searchTerm]);
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900">System Projects</h1>
            </div>
            <p className="text-gray-600">Manage all projects across the entire system</p>
          </div>
          <div className="flex items-center space-x-3 mt-4 md:mt-0">
            <button
              onClick={() => router.push('/superadmin/projects/settings')}
