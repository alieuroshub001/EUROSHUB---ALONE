...
export default function ProjectDetail() {
  ...
  const handleEditProject = () => {
    // Route to appropriate edit page based on user role
    if (user?.role === 'superadmin') {
      router.push(`/superadmin/project-management/projects/${projectId}/edit`);
    } else {
      // Add other role-based routing as needed
  ...
  const renderContent = () => {
    switch (viewMode) {
      case 'boards':
        return <IntegratedKanbanBoard projectId={projectId} userRole={user?.role || 'user'} />;
