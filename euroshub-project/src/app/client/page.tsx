                    ...
                    <div className="min-w-0 flex-1 pt-1.5">
                      <div>
                        <p className="text-sm text-gray-500">
                          Project <span className="font-medium text-gray-900">Website Redesign</span> was completed
                        </p>
                ...
                <li className="relative">
                  <div className="relative flex space-x-3">
                    ...
                    <div className="min-w-0 flex-1 pt-1.5">
                      <div>
                        <p className="text-sm text-gray-500">
                          New team member <span className="font-medium text-gray-900">Sarah Wilson</span> joined the project
                        </p>
